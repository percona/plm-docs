...
??? example "Sample error messages"
    ...
    ```{.text .no-copy}
    2025-06-02T21:25:38.927Z INF Found Recovery Data. Recovering... s=recovery
    ...
    2025-06-02T21:25:38.929Z FTL error="new server: recover Percona ClusterSync for MongoDB: recover: cannot resume: replication is not started or not resuming from failure"
    ```
...
??? example "Example logs"
    ...
    ```{.text .no-copy}
    2025-06-02T21:32:04.592Z INF Starting Cluster Replication s=pcsm
    2025-06-02T21:32:04.592Z DBG Change Replication is resuming s=repl
    2025-06-02T21:32:04.592Z INF Change Replication resumed op_ts=[1748887947,1] s=repl
    2025-06-02T21:32:04.594Z DBG Checkpoint saved s=checkpointing
    ```
